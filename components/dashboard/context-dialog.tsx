  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-2xl max-h-[90vh] flex flex-col">
        ...
        <div className="space-y-2 flex-1 overflow-hidden flex flex-col pt-4">
          <Label htmlFor="context" className="text-sm font-medium">Your Context</Label>
          <Textarea
            id="context"
            value={context}
            ...
            className="min-h-[150px] sm:min-h-[200px] max-h-[300px] sm:max-h-[400px] resize-none overflow-y-auto flex-1 font-light"
            disabled={isLoading}
          />
        ...
        <DialogFooter className="flex-row gap-2 sm:flex-row">
          ...
          <Button onClick={handleSave} disabled={isLoading} className="flex-1 sm:flex-initial rounded-full">
